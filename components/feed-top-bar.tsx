...
export default function FeedTopBar({
  ...
  return (
    <header
      className="sticky top-0 z-20 border-b border-slate-200 bg-slate-50/80 backdrop-blur"
    ...
    >
      <div className="relative flex h-8 items-center px-4">
        ...
        {/* 로고: 뷰포트 정중앙 */}
        <span className="wordmark pointer-events-none absolute left-1/2 -translate-x-1/2 text-[20px] text-slate-900">
          slyde
        </span>
